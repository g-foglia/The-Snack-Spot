...
<div class="prodotti">
<%
    List<Prodotto> prodotti = (List<Prodotto>) request.getAttribute("dolci");
    for(Prodotto prodotto : prodotti){
    if(prodotto.getQtDeposito() != 0){
%>
<form method="post" action="aggiunta-carrello">
    <input type="hidden" name="pagina" value="dolci">
    ...
    <button class="aggcarrello" type="submit" name="option" value="aggiungi" id="addToCart" onclick="prodottoInserito()"><span>Aggiungi Al carrello  </span><i class="fas fa-shopping-cart" style="color: #393E46;"></i></button>
